...
from config import N_STEPS, DT_PHYS, E_MIN, E_MAX, SEED
from data   import hamiltonian, get_dataloaders
from model  import build_model
from train  import train, sample_generative, sample_surrogate
...
def run_variant_D(model, test_raw, device, out_dir="outputs"):
    ...
    import numpy as np
    from pathlib import Path
    from train import sample_generative_projected
