...
from config import SEED, N_EPOCHS, LR
from data   import get_dataloaders
from model  import build_model_A, build_model_BC, build_model_C
from train  import train_A, train_BC, train_C, sample_C, LAMBDA_BASE
...
def main(variant: str = "all"):
    ...
    if len(models) == 3:
        ...
        from eval import evaluate, plot_variant
