...
from Simple_pendulum.Pendulum_conditional_IC.config import SEED
from Simple_pendulum.Pendulum_conditional_IC.data   import get_dataloaders
from Simple_pendulum.Pendulum_conditional_IC.model  import build_model
from Simple_pendulum.Pendulum_conditional_IC.train  import train
from Simple_pendulum.Pendulum_conditional_IC.eval   import run_eval
...
def run_variant_D():
    ...
    from Simple_pendulum.Pendulum_conditional_IC.data import get_dataloaders
    from Simple_pendulum.Pendulum_conditional_IC.model import build_model
    from Simple_pendulum.Pendulum_conditional_IC.eval import run_variant_D as eval_D
