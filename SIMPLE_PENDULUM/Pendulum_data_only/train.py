...
from Simple_pendulum.Pendulum_data_only.config import (
    N_STEPS, BATCH_SIZE, N_EPOCHS, LR, GRAD_CLIP, N_FM_STEPS, SEED
)
from Simple_pendulum.Pendulum_data_only.model import VelocityFieldMLP
...
def sample(
    ...
    """
    from Simple_pendulum.Pendulum_data_only.data import decode_trajectory
    from Simple_pendulum.Pendulum_data_only.config import N_STEPS, STATE_DIM
