...
from Simple_pendulum.Pendulum_2.config import N_STEPS, STATE_DIM, N_EPOCHS, LR, GRAD_CLIP, N_FM_STEPS, SEED, N_FM_STEPS_TRAIN, LAMBDA_BASE, ALPHA_C
from Simple_pendulum.Pendulum_2.data   import decode_trajectory
from Simple_pendulum.Pendulum_2.model  import (
...
def sample_BC(model, n_samples: int, device: str,
    ...
    """
    from Simple_pendulum.Pendulum_2.config import E_MIN, E_MAX
    from Simple_pendulum.Pendulum_2.data   import decode_trajectory, sample_initial_conditions, hamiltonian
...
def train_C(
    ...
    """
    from Simple_pendulum.Pendulum_2.data import hamiltonian
    torch.manual_seed(SEED)
    optimizer = torch.optim.Adam(model.parameters(), lr=lr)
...
def sample_C(model, n_samples: int, device: str,
    ...
    """
    from Simple_pendulum.Pendulum_2.config import E_MIN, E_MAX
    from Simple_pendulum.Pendulum_2.data   import decode_trajectory, sample_initial_conditions
